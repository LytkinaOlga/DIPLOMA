...
insert into tasks (id, name, class_name) values (4, 'Master List Adapter', 'by.bntu.fitr.poisit.lytkina.MigrationMonitoringTool.task.adapter.MasterListAdapterTask');
...
insert into tasks (id, name, class_name) values (6, 'Adapter', 'by.bntu.fitr.poisit.lytkina.MigrationMonitoringTool.task.adapter.MasterListAdapterTask');
...
insert into task_params (id, task_id, name) values (7, 6, 'URL');